...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vote.like'
        db.alter_column('vote_vote', 'like', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Vote.like'
        db.alter_column('vote_vote', 'like', self.gf('django.db.models.fields.BooleanField')())
