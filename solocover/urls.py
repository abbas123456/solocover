...
urlpatterns = patterns('',
    ...
    url(r'^thread/(?P<slug>[-\w\d]+)/(?P<pk>\d+)/$', SongthreadDetailView.as_view(), name='songthread_detail'),
    url(r'^song/add/(?P<songthread_id>\d+)/$', login_required(SongCreateView.as_view()), name='song_create'),
