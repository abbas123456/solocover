...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Song.file_content_type'
        db.add_column('songthread_song', 'file_content_type',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Song.file_content_type'
        db.delete_column('songthread_song', 'file_content_type')
