...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.in_reply_to'
        db.add_column('songthread_comment', 'in_reply_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['songthread.Comment'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.in_reply_to'
        db.delete_column('songthread_comment', 'in_reply_to_id')
