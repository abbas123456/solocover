...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('songthread_comment', 'comment')

        # Adding field 'Comment.content'
        db.add_column('songthread_comment', 'content',
    ...
    def backwards(self, orm):
        ...
        db.add_column('songthread_comment', 'comment',
                      self.gf('django.db.models.fields.TextField')(default='test'),
                      keep_default=False)

        # Deleting field 'Comment.content'
        db.delete_column('songthread_comment', 'content')
