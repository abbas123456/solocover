...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Song.user'
        db.alter_column('songthread_song', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Song', fields ['user']
        db.create_unique('songthread_song', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Song', fields ['user']
        db.delete_unique('songthread_song', ['user_id'])


        # Changing field 'Song.user'
        db.alter_column('songthread_song', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
